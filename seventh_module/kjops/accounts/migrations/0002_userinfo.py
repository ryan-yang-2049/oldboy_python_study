# -*- coding: utf-8 -*-
# Generated by Django 1.11.20 on 2019-05-31 05:48
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emali', models.EmailField(max_length=255)),
                ('is_active', models.BooleanField(default=False)),
                ('gender', models.IntegerField(choices=[(1, '男'), (2, '女')], default=1, verbose_name='性别')),
                ('depart', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='accounts.Department', verbose_name='部门')),
