    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('memo', models.TextField(blank=True, max_length=255, null=True, verbose_name='说明')),
                ...
                ('tech_teachers', models.ManyToManyField(blank=True, null=True, related_name='teach_classes', to='web.UserInfo', verbose_name='任课老师')),
            ],
        ),
    ]
