...
# q.put(4)
# q.put(4,block=False) # 默认block的值是True，如果设置为False以后，运行程序会抛出异常 "queue.Full"
# q.put(4,block=True,timeout=3)  # 如果 timeout=3 3秒以内没有去做，也抛出异常 "queue.Full"
# q.put_nowait(4)  # 也抛出异常 "queue.Full"
# '''
#
